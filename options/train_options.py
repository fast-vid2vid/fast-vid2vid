...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--use_temporal_loss', action='store_true', help='if is a subset for face')      
        self.parser.add_argument('--no_kd_mask',action='store_true', help='if use a kd mask')     
        self.parser.add_argument('--prune_pth', type=str, default='None', help='which pruned model is loaded?')
