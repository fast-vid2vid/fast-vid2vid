...
class BaseOptions():
    ...
    def initialize(self):                
        ...
        self.parser.add_argument('--teacher_ngf', type=int, default=128, help='how many ngf of teacher')
        ...
        #others
        self.parser.add_argument('--use_raw_only', action='store_true', default=False, help='if only use raw??')
        self.parser.add_argument('--prune', action='store_true', default=False, help='if only use raw??')
        self.parser.add_argument('--load_by_pth', action='store_true', default=False, help='If load by best pth???')
        self.parser.add_argument('--load_by_pth_name', type=str, default='None', help='saves results here.')
